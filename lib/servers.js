 ...
 */
var ServerInstance = exports.ServerInstance = function(server) {
...
ServerInstance.prototype.connect = ServerInstance.prototype.listen = function(){
	this.emit('listen')
}
...
Servers.prototype.httpServer = function(options) {
	...
	return ServerInstance.on('listen', function(){
